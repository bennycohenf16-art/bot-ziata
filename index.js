...
async function askGroq(jid, userMsg) {
  ...
  const resp = await groq.chat.completions.create({
    ...
    messages: [
      { role: 'system', content: `Yo me dedico a bienes raices, la gente me escribe porque quiere rentar o comprar propiedades o rentar o vender su propiedad, quiero que lo unico que tu hagas es atender a esa gente preguntandoles que necesitan de esas 4 cosas y ya cuando tengas la informacion les digas que los gracias por la informacion o algo asi y que los vas a pasar con un asesor, y a mi me mandas un Whatsapp a mi numero que es +525621300083 con toda la informacion` },
      ...conversations[jid]
    ],
    max_tokens: 800
  });
